<template>
            ...
            <div class="modal fade" tabindex="-1" :class="{'mostrar' : modal}" rol="dialog" aria-labelledby="myModalLabel" style="overflow-y: scroll;" aria-hidden="true" >
                <div class="modal-dialog modal-primary modal-lg" rol="document">
    ...
    export default {
        ...
        methods : {
            ...
            validarPersona(){
                ...
                if (this.idrol==0) this.errorMostrarMsjPersona.push("Seleccione una Rol para este usuario.");

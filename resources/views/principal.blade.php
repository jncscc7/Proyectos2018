...
<head>
    ...
    <meta name="description" content="Sistema de Informacion Alayart">
    <meta name="author" content="JnCs Systems">
    <meta name="keyword" content="Sistema de Informacion Alayart">
    <link rel="shortcut icon" href="img/favicon.png">
    <title>Sistema de Informacion - Alayart</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <!-- Se crea la plantilla.css que replanza a todos los archivos css -->
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item nav-dropdown">
                            ...
                            <ul class="nav-dropdown-items">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="i#"><i class="icon-bag"></i> Orden de Compra</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item nav-dropdown">
    ...
    <footer class="app-footer">
        <span><a href="http://www.jncs-systems.com">JnCs Systems</a> &copy; 2018</span>
        <span class="ml-auto">Desarrollado por <a href="http://www.jncs-systems.com">JnCs Systems</a></span>
    </footer>
